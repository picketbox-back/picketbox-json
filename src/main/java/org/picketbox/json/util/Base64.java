...
import org.picketbox.json.PicketBoxJSONLogger;
...
public class Base64 {
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset) {
        ...
        // Example: DkLE
            ...
            try {
                ...
                PicketBoxJSONLogger.LOGGER.debug(source[srcOffset] + ": " + (DECODABET[source[srcOffset]]));
                PicketBoxJSONLogger.LOGGER.debug(source[srcOffset + 1] + ": " + (DECODABET[source[srcOffset + 1]]));
                PicketBoxJSONLogger.LOGGER.debug(source[srcOffset + 2] + ": " + (DECODABET[source[srcOffset + 2]]));
                PicketBoxJSONLogger.LOGGER.debug(source[srcOffset + 3] + ": " + (DECODABET[source[srcOffset + 3]]));
                return -1;
            } // end catch
        }
    } // end decodeToBytes
    ...
    public static byte[] decode(byte[] source, int off, int len) {
        ...
        for (i = off; i < off + len; i++) {
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) // White space, Equals sign or better
            {
                ...
                throw PicketBoxJSONMessages.MESSAGES.invalidBase64CharacterMessage(source[i]);
            } // end else:
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            if (file.length() > Integer.MAX_VALUE) {
                throw PicketBoxJSONMessages.MESSAGES.errorDecodingFromBigInputFile(filename, file.length());
            ...
            throw PicketBoxJSONMessages.MESSAGES.errorDecodingFromFile(filename, e);
        } // end catch: IOException
        finally {
            try {
                bis.close();
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            throw PicketBoxJSONMessages.MESSAGES.errorEncodingFromFile(filename, e);
        } // end catch: IOException
        finally {
            try {
                bis.close();
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        public int read() throws java.io.IOException {
            ...
            if (position < 0) {
                ...
                // Else decoding
                    ...
                    if (i == 4) {
                        ...
                        throw PicketBoxJSONMessages.MESSAGES.invalidBase64Padding();
                    } // end
            ...
            // Else error
                ...
                throw PicketBoxJSONMessages.MESSAGES.errorReadingBase64Stream();
            } // end else
        } // end read
        ...
        public void write(int theByte) throws java.io.IOException {
            ...
            // Else, Decoding
                ...
                if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    throw PicketBoxJSONMessages.MESSAGES.invalidBase64CharacterMessage((byte) theByte);
